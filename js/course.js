...
var COURSE = [
  {
    id: 's1', name: '새싹', emoji: '🌱', book: '오른손 다섯 손가락',
  ...
  { id: 's2', name: '바이엘 상', emoji: '🌿', book: '바이엘 상', desc: '한 옥타브(도~높은 도)와 8분음표', goal: 0.8, songs: [] },
  { id: 's3', name: '바이엘 하', emoji: '🍀', book: '바이엘 하', desc: '점음표, 쉼표, 손 넘기기', goal: 0.8, songs: [] },
  { id: 's4', name: '체르니 100 (1)', emoji: '🌳', book: '체르니 100', desc: '빠른 음계와 반복음', goal: 0.7, songs: [] },
  { id: 's5', name: '체르니 100 (2)', emoji: '🌲', book: '체르니 100', desc: '넓은 음역과 가벼운 손가락', goal: 0.7, songs: [] },
  { id: 's6', name: '부르크뮐러', emoji: '🦋', book: '부르크뮐러 25', desc: '느낌을 살려 치는 아름다운 소품', goal: 0.7, songs: [] },
  { id: 's7', name: '소나티네', emoji: '🎼', book: '소나티네', desc: '쿨라우·클레멘티의 작은 소나타', goal: 0.7, songs: [] },
  { id: 's8', name: '체르니 30 (1)', emoji: '🔥', book: '체르니 30', desc: '빠른 손가락, 긴 음계', goal: 0.6, songs: [] },
  { id: 's9', name: '체르니 30 (2)', emoji: '⚡', book: '체르니 30', desc: '더 빠르고 긴 곡', goal: 0.6, songs: [] },
  { id: 's10', name: '명곡', emoji: '👑', book: '명곡', desc: '누구나 아는 클래식 명곡', goal: 0.7, songs: [] }
];
...
function courseStages() {
  return COURSE.map(function (st) {
    ...
    return { id: st.id, name: st.name, emoji: st.emoji, book: st.book, desc: st.desc, goal: st.goal,
